...
class Jadwal extends \yii\db\ActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            'id' => 'ID',
            'periode_dosen_pengajar' => 'Periode',
            'departemen_dosen_pengajar' => 'Departemen',
            'nip_nidn_dosen_pengajar' => 'Nama Dosen',
            'periode_mata_kuliah_pengajar' => 'Periode Mata Kuliah Pengajar',
            'program_studi_mata_kuliah_pengajar' => 'Program Studi',
            'kategori_koefisien_program_studi_mata_kuliah_pengajar' => 'Kategori Koefisien',
            'nama_mata_kuliah_pengajar' => 'Nama Mata Kuliah',
            'jenis_mata_kuliah_pengajar' => 'Jenis Mata Kuliah',
